<x-layouts.site>
    ...
    <section class="container pb-5 mb-md-2 mb-lg-4">
        <h1 class="border-bottom pb-4">We are Lebara</h1>
    ...
    <section class="container my-5 pt-xl-5 pt-lg-4 pt-md-3 pb-lg-5 pb-md-4 pb-3">
        <h2 class="h1 mt-xl-3 mb-4 pb-3 text-center">Why Lebara?</h2>
        ...
        <ul class="nav nav-tabs flex-nowrap justify-content-sm-center overflow-auto mb-lg-4 mb-3 pb-md-3 pb-2 text-nowrap" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="landing-saas-v4.html#economic-analysis" class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="false" tabindex="-1">
                    <i class="bx bx-star opacity-60 me-2 fs-lg"></i>
                    Economic Analysis
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="landing-saas-v4.html#investments" class="nav-link" data-bs-toggle="tab" role="tab" aria-selected="false" tabindex="-1">
                    <i class="bx bx-briefcase-alt-2 opacity-60 me-2 fs-lg"></i>
                    Investments
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a href="landing-saas-v4.html#corporate-finance" class="nav-link active" data-bs-toggle="tab" role="tab" aria-selected="true">
            ...
            <div class="tab-pane fade" id="economic-analysis" role="tabpanel">
                <div class="row align-items-center pt-3 pt-sm-4 pt-md-0 px-3 px-sm-4 px-lg-0">
                    <div class="col-lg-4 col-md-5 offset-lg-1 text-center text-md-start">
                        ...
                        <a href="landing-saas-v4.html#" class="btn btn-primary">Learn more</a>
                    </div>
